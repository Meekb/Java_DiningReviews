...
INSERT INTO restaurants (id, name, peanutRating, eggRating, dairyRating, overallRating) VALUES (3, 'Fresh Everything', 5, 5, 4, 4.66);
INSERT INTO restaurants (id, name, peanutRating, eggRating, dairyRating, overallRating) VALUES (4, 'The Buffet Depot', 1, 2, 2, 1.66);

INSERT INTO reviews (id, username, restaurant, peanutScore, eggScore, dairyScore, commentary) VALUES (1, 'LargeMarge', 1, 4, 2, 2, 'Wow! You sit on a toilet while eating the leftovers from Leftovers wrapped in a soft taco shell, smothered in day-old salsa, and served in a trough!');
INSERT INTO reviews (id, username, restaurant, peanutScore, eggScore, dairyScore, commentary) VALUES (2, 'Sergeant_Burgermarpher', 2, 4, 2, 3, 'Leftovers from The Buffet Depot scooped up and served hot or cold - your choice!');
INSERT INTO reviews (id, username, restaurant, peanutScore, eggScore, dairyScore, commentary) VALUES (3, 'MisterBaby', 3, 5, 5, 4,'Much Fresh. Really Yum.');
INSERT INTO reviews (id, username, restaurant, peanutScore, eggScore, dairyScore, commentary) VALUES (4, 'TheJanus', 4, 1, 2, 2, 'This place has a miniature train that pulls the buffet along the winding tracks. Put your table railroad crossing guard down for the train to stop for you and your sweetie to select the desserts. You wont have to lift a finger for romanace here!');